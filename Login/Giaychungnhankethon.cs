...
namespace Login
{
    public class Giaychungnhankethon
    {
        ...
        public Giaychungnhankethon(string hotenvo, string ngaysinhvo, string dantocvo, string quoctichvo, string noicutruvo, string giaytotuythanvo, string hotenchong, string ngaysinhchong, string dantocchong, string quoctichchong, string noicutruchong, string giaytotuythanchong, string noidk, DateTime ngaydk)
        {
